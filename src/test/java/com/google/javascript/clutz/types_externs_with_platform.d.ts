...
declare namespace ಠ_ಠ.clutz.typesWithExterns {
  ...
  class ExtendsXMLHttpRequest_Instance extends XMLHttpRequest_Instance {
  }
  var a : { a : number } ;
  var b : IArguments ;
  var c : NodeList ;
...
declare namespace ಠ_ಠ.clutz {
  ...
  class DOMTokenList_Instance implements ArrayLike < string > {
    private noStructuralTyping_: any;
    [key: string]: any;
...
declare namespace ಠ_ಠ.clutz {
  ...
  class ExtendableEvent_Instance extends Event_Instance {
    ...
    waitUntil (f : PromiseLike < any > ) : any ;
  }
}
declare namespace ಠ_ಠ.clutz {
...
declare namespace ಠ_ಠ.clutz {
   ...
   */
  interface ITypedArray extends ArrayLike < number > {
    BYTES_PER_ELEMENT : number ;
...
declare namespace ಠ_ಠ.clutz {
  ...
  class MSPointerEvent_Instance extends Event_Instance {
    height : number ;
    hwTimestamp : number ;
    initPointerEvent (a : string , b : boolean , c : boolean , d : Window , e : number , f : number , g : number , h : number , i : number , j : boolean , k : boolean , l : boolean , m : boolean , n : number , o : Element , p : number , q : number , r : number , s : number , t : number , u : number , v : number , w : number , x : number , y : number , z : number , p0 : boolean ) : void ;
    isPrimary : boolean ;
...
declare namespace ಠ_ಠ.clutz.Math {
  function hypot (value1 : number ,  ...var_args : ( number ) [] ) : number ;
}
declare namespace ಠ_ಠ.clutz.Math {
...
declare namespace ಠ_ಠ.clutz {
  ...
  class NodeList_Instance implements ArrayLike < any > {
    private noStructuralTyping_: any;
    [key: string]: any;
    item (index : number ) : Node ;
    length : number ;
...
declare namespace ಠ_ಠ.clutz.Object {
  function assign (target : Object ,  ...var_args : ( Object ) [] ) : Object ;
}
declare namespace ಠ_ಠ.clutz.Object {
  function getOwnPropertySymbols ( ) : any [] ;
}
declare namespace ಠ_ಠ.clutz.Object {
  function is (a : any , b : any ) : boolean ;
}
declare namespace ಠ_ಠ.clutz.Object {
  function setPrototypeOf ( ) : void ;
}
declare namespace ಠ_ಠ.clutz {
...
declare namespace ಠ_ಠ.clutz.String {
  function raw (template : string ,  ...var_args : any [] ) : string ;
}
declare namespace ಠ_ಠ.clutz {
...
declare namespace ಠ_ಠ.clutz.chrome.runtime {
  var lastError__clutz_alias : Object ;
}
declare namespace ಠ_ಠ.clutz.chrome.runtime.lastError {
  var message : string ;
}
declare namespace ಠ_ಠ.clutz.chrome.runtime {
  function sendMessage (extensionIdOrMessage : any , opt_messageOrOptsOrCallback ? : any , opt_optsOrCallback ? : Object , opt_callback ? : (a : any ) => void ) : void ;
}
...
declare namespace ಠ_ಠ.clutz {
  function clearImmediate (immediateID : number ) : any ;
}
declare namespace ಠ_ಠ.clutz {
...
declare namespace ಠ_ಠ.clutz {
  function importScripts ( ...var_args : ( string ) [] ) : any ;
}
declare namespace ಠ_ಠ.clutz {
...
declare namespace ಠ_ಠ.clutz {
  function mozRequestAnimationFrame (callback : (a : number ) => any , opt_element ? : Element ) : number ;
}
declare namespace ಠ_ಠ.clutz {
...
declare namespace ಠ_ಠ.clutz {
  function msRequestAnimationFrame (callback : (a : number ) => any , opt_element ? : Element ) : number ;
}
...
declare namespace ಠ_ಠ.clutz {
  function oRequestAnimationFrame (callback : (a : number ) => any , opt_element ? : Element ) : number ;
}
declare namespace ಠ_ಠ.clutz {
  function openDatabase (name : string , version : string , description : string , size : number , opt_callback ? : DatabaseCallback | ( (a : Database ) => any ) ) : Database ;
}
...
declare namespace ಠ_ಠ.clutz {
  function prompt (message : string , opt_value ? : string ) : string ;
}
declare namespace ಠ_ಠ.clutz {
  function requestAnimationFrame (callback : (a : number ) => any , opt_element ? : Element ) : number ;
}
declare namespace ಠ_ಠ.clutz {
...
declare namespace ಠ_ಠ.clutz {
  function setInterval (callback : ( ( ...a : any [] ) => any ) | string , opt_delay ? : number ) : number ;
}
declare namespace ಠ_ಠ.clutz {
  function setTimeout (callback : ( ( ...a : any [] ) => any ) | string , opt_delay ? : number ,  ...var_args : any [] ) : number ;
}
declare namespace ಠ_ಠ.clutz {
  var top : Window ;
}
...
declare namespace ಠ_ಠ.clutz {
  function webkitRequestAnimationFrame (callback : (a : number ) => any , opt_element ? : Element ) : number ;
}
declare namespace ಠ_ಠ.clutz {
  /**

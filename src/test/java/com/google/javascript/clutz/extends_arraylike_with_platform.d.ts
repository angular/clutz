declare namespace ಠ_ಠ.clutz {
  class module$exports$extend$arraylike$A extends module$exports$extend$arraylike$A_Instance {
  }
  class module$exports$extend$arraylike$A_Instance implements ArrayLike < any > {
...
declare namespace ಠ_ಠ.clutz {
  class module$exports$extend$arraylike$B extends module$exports$extend$arraylike$B_Instance {
  }
  class module$exports$extend$arraylike$B_Instance implements ಠ_ಠ.clutz.module$exports$extend$arraylike$I {
    private noStructuralTyping_: any;
    [ key: number ]: any ;
    length : number ;
  }

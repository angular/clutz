declare namespace ಠ_ಠ.clutz {
  class module$exports$a$b$StaticHolder extends module$exports$a$b$StaticHolder_Instance {
  }
  class module$exports$a$b$StaticHolder_Instance {
...
declare namespace ಠ_ಠ.clutz {
  enum module$exports$a$b$StaticHolder$AnEnum {
    X ,
    Y ,
  }
}

declare namespace ಠ_ಠ.clutz.module$exports$index_signature {
  ...
  class ShouldContainIndexSignature_Instance implements ಠ_ಠ.clutz.module$exports$index_signature.InterfaceExtendingIArrayLike {
    private noStructuralTyping_: any;
    [ key: number ]: string ;
    length : number ;
  }
  ...
  class ShouldNotContainIndexSignature_Instance extends ಠ_ಠ.clutz.module$exports$index_signature.ImplementsIArrayLike {
  }

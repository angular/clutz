...
// Generated from src/test/java/com/google/javascript/clutz/testdata/partial/goog_module_forward_declare.js
declare namespace ಠ_ಠ.clutz {
  class module$contents$legacy$namespace$forward$declare_ClassExtendingMissingForwardDeclare extends ಠ_ಠ.clutz.module$exports$missing$forward$Declare {
    private noStructuralTyping_module$contents$legacy$namespace$forward$declare_ClassExtendingMissingForwardDeclare : any;
    constructor ( ) ;
  }
}
